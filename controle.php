...
<html>
    <head>
        ...
        <title>SD - Pedidos Controle Clientes</title>
        ...
        <script type="text/javascript">
            ...
            function editUser() {
                ...
                if (row) {
                    ...
                    $('#fm').form('load', row);
                    url = 'atualizar_cadastro.php?id=' + row.id;
                }
            }
            function saveUser() {
                $('#fm').form('submit', {
    ...
    <body>
        ...
        <!-- Copyright -->
        <div class="copyright">
                 &copy; SD - Pedidos - Design: <a href="https://plus.google.com/112968268709665854968">Donizete Debroski</a></li>
        </div>
